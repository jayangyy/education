...
//        return db.queryBeanList(BookType.class,"SELECT 代码 code, 名称 type FROM 类型");
//    }
//    
...
//        return db.queryBeanList(BookType.class,"SELECT 代码 code, 名称 type FROM 小类 WHERE 代码 LIKE @0", code + '%');
//    }
}
